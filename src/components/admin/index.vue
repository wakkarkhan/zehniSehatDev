        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="page-title">Welcome {{this.admin_data_to_show.admin_name}}!</h3>
                            <ul class="breadcrumb">
                            ...
                            <div class="card-body">
                                <div class="dash-widget-header">
                                    ...
                                    <div class="dash-count">
                                        <h3>{{this.admin_data_to_show.total_therapists}}</h3>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="dash-widget-header">
                                    ...
                                    <div class="dash-count">
                                        <h3>{{this.admin_data_to_show.total_patients}}</h3>
                                    </div>
                                </div>
                                <div class="dash-widget-info">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="dash-widget-header">
                                    ...
                                    <div class="dash-count">
                                        <h3>{{this.admin_data_to_show.total_appointments}}</h3>
                                    </div>
                                </div>
                                <div class="dash-widget-info">
