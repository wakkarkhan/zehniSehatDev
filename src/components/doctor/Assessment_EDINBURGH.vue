...
export default {
    data() {
        return {
            ...
            quiz : {
            title: "Edinburgh Postnatal Depression Scale  (EPDS)[1]",
            questions: [
                {
                ...
                answers: [
                    {
                    text: 'Yes, most of the time I havent been able to cope at all',
                    value: 3
                    },
                    {
                    text: 'Yes, sometimes I havent been coping as well as usual',
                    value: 2
                    },
                    {
