										...
										<div class="chat-scroll">
											<a href="javascript:void(0);" class="media">
												...
												<div class="media-body">
													<div>
														<div class="user-name">Nicolas Flowers</div>
											...
											<a href="javascript:void(0);" class="media read-chat active">
												...
												<div class="media-body">
													<div>
														<div class="user-name">Julio Hart</div>
											...
											<a href="javascript:void(0);" class="media">
												...
												<div class="media-body">
													<div>
														<div class="user-name">Kimberly Klingler </div>
											...
											<a href="javascript:void(0);" class="media read-chat">
												...
												<div class="media-body">
													<div>
														<div class="user-name">Robert Menard</div>
											...
											<a href="javascript:void(0);" class="media read-chat">
												...
												<div class="media-body">
													<div>
														<div class="user-name">Eric Parks</div>
											...
											<a href="javascript:void(0);" class="media read-chat">
												...
												<div class="media-body">
													<div>
														<div class="user-name">Ashley King</div>
											...
											<a href="javascript:void(0);" class="media read-chat">
												...
												<div class="media-body">
													<div>
														<div class="user-name">Mark John</div>
											...
											<a href="javascript:void(0);" class="media read-chat">
												...
												<div class="media-body">
													<div>
														<div class="user-name">Danny Grizzle</div>
											...
											<a href="javascript:void(0);" class="media read-chat">
												...
												<div class="media-body">
													<div>
														<div class="user-name">Erica Anderson</div>
											...
											<a href="javascript:void(0);" class="media read-chat">
												...
												<div class="media-body">
													<div>
														<div class="user-name">James Madrid</div>
